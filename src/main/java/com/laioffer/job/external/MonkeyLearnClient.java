...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "9bf04c9974b578838cbcc95c95d773bc62477f00";
    ...
    public List<Set<String>> extract(List<String> articles) {// articles received from request
        ObjectMapper mapper = new ObjectMapper();
        CloseableHttpClient httpClient = HttpClients.createDefault(); // static create

        HttpPost request = new HttpPost(EXTRACT_URL);
        request.setHeader("Content-type", "application/json");
        request.setHeader("Authorization", "Token " + AUTH_TOKEN);// must have space after Token or will get 401 error
        ...
        ResponseHandler<List<Set<String>>> responseHandler = response -> {
            ...
            // map entity concent to ExtractResponseItem.class format
        ...
        // even has exception, this line will execute after catch
        return Collections.emptyList();
    }
